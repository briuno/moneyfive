  ...
  <header class="container">
    <nav class="wrapper" aria-label="Menu Principal">
      ...
      <ul>
        ...
        <li><a class="header__link" href="../admin/gerenciar_solicitacoes.php">Gerenciar Solicitações de Consultoria</a></li>
        <li><a class="header__link" href="../admin/gerenciar_newsletter.php">Gerenciar Assinaturas da Newsletter</a></li>
      </ul>
